                ...
                {parcels.map((parcel) => (
                  <tr key={parcel._id}>
                    ...
                    <td>
                      ...
                      >
                        <i className="bi bi-check-circle me-1"></i> Mark as Delivered
                      </button>
                    </td>
                  </tr>
                ))}
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>
                  Are you sure you want to update this parcel's status to "Delivered"? 
                  This indicates that the parcel has been handed over to the recipient or is ready for pickup.
                </p>
                {selectedParcel && (
